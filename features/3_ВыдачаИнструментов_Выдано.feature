...
Функционал: Проверка работы документа Выдача инструментов (выдано)

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий
	И я закрываю все окна клиентского приложения

Сценарий: Проверка выдачи инструмента с оплатой и остатком
	...
	* Создание документа Выдача инструментов на основании Заказа клиента
		...
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна 'Выдача инструментов * от *' в течение 20 секунд
